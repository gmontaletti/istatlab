...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  eval = requireNamespace("istatlab", quietly = TRUE)
)
```
...
Il pacchetto **istatlab** fornisce strumenti per scaricare, elaborare e analizzare i dati sul mercato del lavoro italiano dall'ISTAT (Istituto Nazionale di Statistica) attraverso la sua API SDMX.

...
The **istatlab** package provides tools for downloading, processing, and analyzing Italian statistical data from ISTAT (Istituto Nazionale di Statistica) through its SDMX API.

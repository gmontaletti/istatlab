...
- **Data Download**: Streamlined access to ISTAT’s SDMX API with
  automatic retry and error handling
- **HVD API Support**: Access ISTAT’s High Value Datasets through HVD v1
  (SDMX 2.1) and v2 (SDMX 3.0) endpoints
...
- [`download_hvd_data()`](https://gmontaletti.github.io/istatlab/reference/download_hvd_data.md):
  Download data directly from HVD endpoints
...
Statistical Data from ISTAT. R package version 0.7.0.

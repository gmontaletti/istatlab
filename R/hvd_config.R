...
#' version and response format. The SDMX content negotiation headers differ
#' between v1 (SDMX 2.1) and v2 (SDMX 3.0) for data responses.
#'
...
#'
#' @keywords internal
get_hvd_accept_header <- function(api_version, format = "csv") {
  # 8a. Input validation -----
